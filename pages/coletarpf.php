...
<header class="header" id="header">
        <nav class="navbar coletarpfselect">
    ...
    <main class="conteudo">
        ...
        <section class="div-title">
            <div class="title">
                <span>Bem Vindo !</span>
                <h1>Colete seu leads PF aqui:</h1>
            </div>
        </section>
        <section class="painel2 colum">
            <div class="opc-filter">
                <select class="item-filter" name="Estado"><img src="../icons/chevron-down-outline.svg" alt="">
                    <option value="SaoPaulo">São Paulo</option>
                </select>
                <select class="item-filter" name="Cidade"><img src="../icons/chevron-down-outline.svg" alt="">
                    <option value="SaoPaulo">São Paulo</option>
                </select>

                <select class="item-filter" name="Genero"><img src="../icons/chevron-down-outline.svg" alt="">
                    <option value="masculino">Masculino</option>
                    <option value="feminino">Feminino</option>
                </select>

                <select class="item-filter" name="" optgroup="sadasds"><img src="../icons/chevron-down-outline.svg" alt="">
                    <option value=""></option>
                </select>
                <select class="item-filter">Profição <img src="../icons/chevron-down-outline.svg" alt=""></select>
            </div>
            <div class="main1">
                <div class="title">
                    <h2>Leads</h2>
